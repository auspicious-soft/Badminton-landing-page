...
const AppShowcase = () => {
  const screenshots = [
    {
      title: "Browse Courts",
      image: "https://images.pexels.com/photos/4792282/pexels-photo-4792282.jpeg?auto=compress&cs=tinysrgb&w=300&h=600&fit=crop"
    },
    {
      title: "Book Matches",
      image: "https://images.pexels.com/photos/8088495/pexels-photo-8088495.jpeg?auto=compress&cs=tinysrgb&w=300&h=600&fit=crop"
    },
    {
      title: "Track Games",
      image: "https://images.pexels.com/photos/5615665/pexels-photo-5615665.jpeg?auto=compress&cs=tinysrgb&w=300&h=600&fit=crop"
    }
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Intuitive design meets powerful functionality. See how easy it is to find and book your next match.
          </p>
        </div>
              ...
              >
                ...
                <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2">
                  <div className="bg-white rounded-lg shadow-lg px-4 py-2">
                    <p className="font-semibold text-sm text-gray-900">{screenshot.title}</p>
                  </div>
                </div>
              </div>
            ))}
