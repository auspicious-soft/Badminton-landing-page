import firstImage from "../../assets/pexels-roger-aribau-gisbert-19420784-8485104.jpg";
import secondImage from "../../assets//high-angle-palettes-balls.jpg";
import thirdImage from "../../assets/sporty-women-playing-paddle-tennis.jpg";
