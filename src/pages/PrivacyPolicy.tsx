        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              At MatchAce, we respect your privacy and are committed to protecting your personal data. This privacy policy explains how we collect, use, and safeguard your information when you use our mobile application and services.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              <li>With other players when you join matches (name and skill level only)</li>
          ...
          <section className="mb-8">
            ...
            <div className="mt-4 p-4 bg-gray-50 rounded-lg">
              <p className="text-gray-700">
                Email: <a href="mailto:privacy@matchace.com" className="text-blue-600 hover:text-blue-700">privacy@matchace.com</a><br />
